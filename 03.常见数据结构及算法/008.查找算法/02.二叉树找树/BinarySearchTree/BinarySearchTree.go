...
func (tree *BinarySearchTree) Delete(value int64) {
	...
	if parent == nil && node.Left == nil && node.Right == nil {
		...
		// 第三种情况:删除的节点下有两个子树,因为右子树的值都比左子树大,那么用右子树中的最小元素来替换删除的系欸但,这时二叉查找树的性质又满足了
		...
		// 左子树不为空
		if node.Left != nil {
			// 如果删除的节点是父亲的左儿子,让删除的节点的左子树接班
			if parent.Left != nil && value == parent.Value {
